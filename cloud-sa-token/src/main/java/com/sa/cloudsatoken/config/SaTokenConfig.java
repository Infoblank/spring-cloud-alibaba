...
public class SaTokenConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new SaRouteInterceptor((req, res, handler) -> {
            ...
            //SaRouter.match("/**", r -> StpUtil.checkPermission("admin")).back();
            ...
            SaRouter.match("/**").notMatch("/validation/validEntity/valid/json","/js/*.js","/css/*.css").check(r->StpUtil.checkLogin());
            //SaRouter.match("/token/**", r -> StpUtil.checkPermission("user"));
        })).addPathPatterns("/**");
    }
}
